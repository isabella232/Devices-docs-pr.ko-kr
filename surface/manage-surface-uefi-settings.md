...
장치에 따라 TPM이 사용 또는 사용되지 않도록 설정되어 있는지 여부도 볼 수 있습니다. **TPM** 사용 설정이 없는 경우 그림 5에 표시된 Windows tpm.msc를 열어 상태를 검사합니다. TPM은 BitLocker로 디바이스 데이터에 대한 암호화를 인증하는 데 사용됩니다. 자세한 내용은 BitLocker [개요를 참조하세요.](https://docs.microsoft.com/windows/security/information-protection/bitlocker/bitlocker-overview) 
 ...
 *관리 그림 8. 제로 터치 UEFI 관리* 및 기타 기능에 대한 액세스 관리 
