...
Surface의 경우 UEFI(Unified Extensible Firmware Interface)<sup> [1](#references)</sup>은 사장에서 유지 관리되고, Windows 업데이트를 통해 정기적으로 업데이트되고, Windows Autopilot을 통해 관리를 위해 원활하게 배포되어 장치를 부팅하기 전에 위험을 최소화하고 펌웨어 수준에서 제어를 극대화합니다. Microsoft는 UEFI에서 UEFI에서 관리되는 Open Source Project [Mu](https://microsoft.github.io/mu/)를 통해 GitHub 코드베이스를 Microsoft Endpoint Manager.

## <a name="microsoft-designed-and-built-components"></a>Microsoft에서 디자인 및 구축한 구성 요소

칩에서 클라우드로의 Surface의 모든 계층은 Microsoft에서 유지 관리하며, 궁극적인 제어, 사전 보호 및 업무가 완료되는 곳과 장소에 관계가 없습니다. Surface 디바이스는 Microsoft에서 제공하는 가장 강력한 보안 프로토콜을 함께 제공하며, IT 복잡성을 줄이고 사용자가 업무에 집중할 수 있도록 하여 간소화된 관리를 지원합니다.

Surface는 독립적인 방어 하위 구성 요소의 계층을 활용하여 심층 방어 접근 방식을 통해 보안을 강화합니다. 칩에서 클라우드로 또는 고급 위협을 방지, 감지, 조사 및 대응하는 끝점용 AI 기반 Microsoft Defender에 대한 신뢰 루트를 보장하는 UEFI에서 Surface는 Microsoft의 기본 제공 위치가 bolt-on보다 더 나은 위치를 적용합니다.
...
| 비즈니스용 Windows Hello      | PC 및 모바일 장치에서 암호를 강력한 2단계 인증으로 대체합니다. 이 생체 인식 인증은 장치에 연결되는 새로운 유형의 사용자 자격 증명으로 구성됩니다.                                                                                                                   | [비즈니스 Windows Hello 작동 방식 - Microsoft 365 보안](/windows/security/identity-protection/hello-for-business/hello-how-it-works) |
...
| 엔드포인트용 Microsoft Defender | 네트워크가 고급 위협을 방지, 감지, 조사 및 대응하는 데 도움이 하도록 설계된 엔터프라이즈 끝점 보안 플랫폼을 제공합니다.                                                                                                                                                                               | [엔드포인트용 Microsoft Defender](/microsoft-365/security/defender-endpoint/microsoft-defender-endpoint)                 |

## <a name="factory-level-security-protocols-and-inspection"></a>공장 수준 보안 프로토콜 및 검사

펌웨어에서 운영 체제 및 최종 어셈블리 전에 모든 하드웨어 구성 요소까지 Surface 디바이스는 물리적으로 보안이 유지된 개발 및 제조 시설의 공급망 공격으로부터 안전합니다.

정의상, 보안 공급망은 품질, 성능 및 운영 목표를 충족하는 완성된 제품을 제공합니다. 간단히 말하면, 보안 공급망은 모든 구성 요소가 정품이며 무단 또는 악의적인 조작이나 사보타지가 없는지 보장합니다. Microsoft는 UEFI 펌웨어에서 운영 체제까지 모든 것이 Microsoft에서 직접 오는 보안이 유지되는 공장에서 장치를 제조합니다. 타사 BIOS 공급업체는 관련이 없습니다. 이는 Surface 제품에 대한 공급망 공격으로부터 보호하는 방법의 강력한 부분입니다. 디바이스에서 필요하지 않은 시스템 관리 모드 SMM 기능을 포함하여 사용되지 않는 코드를 제거하여 UEFI에서 Surface 공격을 줄입니다.

외부 인터넷 기반 공격, 침입 및 기타 위협으로부터 시설을 보호하려면 다음을 비롯한 중요한 영역에서 지속적인 투자가 필요합니다.

- 최종 어셈블리 위치에서 모든 구성 요소의 엄격한 검사 및 테스트
- 공장에서 높은 수준의 물리적 보안을 유지 관리합니다.
- Microsoft에서 유지 관리하는 펌웨어, 드라이버 및 OS만 사용
...
Surface는 기본 제공 및 Windows 더욱 강력한 보안을 고객에게 제공하기 위해 기본적으로 제공되는 향상된 하드웨어 보안 기능을 제공합니다.
...
다음 그림과 같이 펌웨어의 무결성은 각 단계에서 전원 단추를 눌러 운영 체제를 실행하는지 검사합니다.

:::image type="content" source="images/secboot.png" alt-text="그림 1. Surface 디바이스용 보안 부팅":::
...
악성 소프트웨어 공격으로부터 디바이스를 보호하기 위해 Surface는 보안 부팅을 통해 인증 버전의 Windows 10 시작하고 펌웨어가 출고 시 정품으로 정품이 되도록 합니다.

Surface 디바이스의 SoC에는 보안 프로세서가 다른 모든 코어와 분리되어 있습니다. Surface 디바이스를 처음 시작하면 보안 프로세서만 시작된 후 다른 모든 것이 로드될 수 있습니다. 보안 부팅은 드라이버 및 운영 체제를 비롯한 부팅 프로세스 구성 요소가 유효한 서명 및 알려진 서명의 데이터베이스에 대해 유효성을 검사하는 데 사용됩니다. 이렇게 하면 일상적인 사용자 환경으로 나타나는 악성 코드를 실행하는 복제 또는 수정된 시스템의 공격을 방지할 수 있습니다. 자세한 내용은 [보안 부팅 개요](/windows-hardware/design/device-experiences/oem-secure-boot)를 참조하세요.

운영 체제가 Microsoft에서 시작된 것으로 확인되고 Surface 디바이스가 부팅 프로세스를 완료하면 장치는 실행 코드를 확인합니다. 운영 체제 보안에 대한 이 접은 방식으로 모든 실행 파일에 대한 코드 서명을 식별하여 제한 사항을 통과하는 기능만 런타임으로 로드하도록 할 수 있습니다. 이 코드 서명 방법을 사용하면 운영 체제에서 만든 이를 확인하고 장치에서 실행하기 전에 코드가 변경되지 않은지 확인할 수 있습니다.

## <a name="drtm-protection-in-amd-devices"></a>AMD 장치의 DRTM 보호

AMD 프로세서가 포함된 Surface 디바이스는 보안 부팅을 동일하게 구현합니다. Surface Laptop 4와 AMD Ryzen Microsoft Surface Edition 프로세서는 DRTM(Dynamic Root of Trust Measurements)을 사용하여 초기 전원 설정으로부터 펌웨어를 보호합니다. DRTM은 모든 COUS를 제어하여 측정된 경로를 따라 실행을 강요하고, 다양한 단계에서 신뢰를 다시 구축하여 시스템 펌웨어/소프트웨어의 무결성을 검증합니다. 초기에 이 신뢰할 수 있는 상태로 전환하면 부팅 단계에서 잠재적인 공격에 대한 보호가 추가됩니다.

DRTM은 TSME(Total System Memory Encryption)를 사용하여 측정 단위를 암호화하여 보호합니다. TSME를 설정한 후 시스템 재설정을 제외하고는 지워야 합니다. 각 재설정에 대한 새 암호화 키는 보안을 위해 일회용 암호화를 보장합니다.
...
| 기능 | 설명 | 세부 정보 |
| ------- | ----------- | ---------- |
| DCFI(장치 펌웨어 구성 인터페이스) | 제로 터치 장치 프로비전을 통해 클라우드 규모의 원격 펌웨어 관리를 제공합니다. Microsoft의 UEFI는 더 강력한 DCFI 구현을 허용하여 조직에서 하드웨어 요소를 사용하지 않도록 설정하고 Intune을 사용하여 UEFI를 원격으로 잠글 수 있도록 합니다. ¹                                                                                                                                                                          | [Surface UEFI 설정의 Intune 관리](surface-manage-dfci-guide.md)<br> <br>[Surface UEFI 설정 관리](manage-surface-uefi-settings.md)                                          |
...
| 비즈니스용 Windows 업데이트                    | IT 관리자가 조직의 Windows 10 장치를 Windows 업데이트 서비스에 직접 연결하여 최신 보안 방어, Windows 기능 및 Surface 펌웨어로 지속적으로 업데이트할 수 있도록 Windows 있습니다. 그룹 정책 또는 MDM 솔루션(예: Microsoft Intune)을 사용하여 Surface 디바이스 업데이트 방법 및 Windows 제어하는 비즈니스용 업데이트 설정을 구성할 수 있습니다. | [비즈니스용 Windows 업데이트](/windows/deployment/update/waas-manage-updates-wufb)<br> <br>[Surface 드라이버 및 펌웨어 업데이트 관리 및 배포](manage-surface-driver-and-firmware-updates.md) |
