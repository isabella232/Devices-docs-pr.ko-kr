...
| Wake-on-LAN from S4/S5 sleep modes  | No                                                          | 예                                                                                                 |          Yes        |
| Network PXE boot                    | Yes                                                         | 예                                                                                                 |        Yes          |
| SEMM host access control            | No                                                          | 예                                                                                                 | No               |
| SEMM port access control<sup>2</sup>          | No                                                          | 예                                                                                                 | No               |
