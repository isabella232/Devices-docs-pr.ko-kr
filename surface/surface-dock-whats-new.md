...
- SURFACE Enterprise 관리 모드(SEMM)를 사용하면 IT 관리자가 Surface Dock 2의 포트를 보호할 수 있습니다. 자세한 내용은 Surface Enterprise [모드로 Surface Dock 2 포트 보호를 참조하세요.](secure-surface-dock-ports-semm.md)
...
- Windows 10 버전 1809. 7, Windows, Windows 8 또는 비 Surface 호스트 디바이스는 지원되지 않습니다. Surface Dock 2는 다음 Surface 디바이스에서 작동합니다.
