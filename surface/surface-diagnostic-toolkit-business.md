...
> [!NOTE]
> 비즈니스용 Surface Toolkit 디바이스를 위해 제작되었습니다. 디바이스가 개인 장치로 회사 또는 학교에서 관리되지 않는 경우 [Surface Diagnostic Toolkit](https://support.microsoft.com/help/4037239/surface-fix-common-surface-problems-using-surface-diagnostic-toolkit) 실행합니다.
...
2. Surface Tools for IT Windows (.msi)에서 SDT .msi 설치 관리자 패키지(설치 관리자 패키지)를 [다운로드합니다.](https://www.microsoft.com/download/details.aspx?id=46703)
...
4. SDT 설치 마법사가 나타나면 **다음,** EULA(최종 사용자 사용권 계약)에 동의를 클릭합니다.
