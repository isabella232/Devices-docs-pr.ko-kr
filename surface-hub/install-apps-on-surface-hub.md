...
- Microsoft Store에 앱을 제출 하는 경우 개발자는 Surface Hub에서 앱을 실행할 수 있도록 디바이스 패밀리 가용성 및 조직 라이선스 옵션을 설정 해야 합니다.
...
### 비즈니스용 Microsoft Store에서 앱 패키지 다운로드
...
|-----------------------------|----------------------------------------|
| 구성 관리자와의 온-프레미스 MDM (버전 1602 시작) | 예 |
|
| 타사 MDM 공급자    | MDM 공급자가 오프라인 사용이 허가된 앱 패키지 배포를 지원하는지 확인합니다. |

**Microsoft Endpoint Configuration Manager를 사용 하 여 앱을 원격으로 배포 하려면**

> [!NOTE]
> 이러한 지침은 Microsoft 끝점 구성 관리자의 현재 분기를 기반으로 합니다.

1. Surface Hub를 구성 관리자에 등록 합니다. 자세한 내용은 [MDM에 Surface Hub 등록](manage-settings-with-mdm-for-surface-hub.md#enroll-into-mdm)을 참조하세요.
...
12. Surface Hub에 응용 프로그램을 배포합니다. 자세한 내용은 [Microsoft Endpoint Configuration Manager를 사용 하 여 응용 프로그램 배포](https://docs.microsoft.com/sccm/apps/deploy-use/deploy-applications)를 참조 하세요.
13. 필요한 경우 비즈니스용 Store에서 새 패키지를 다운로드하고 Configuration Manager에 응용 프로그램 버전을 게시하여 앱을 업데이트합니다. 자세한 내용은 [Microsoft Endpoint Configuration Manager를 사용 하 여 응용 프로그램 업데이트 및 사용 중지](https://technet.microsoft.com/library/mt595704.aspx)를 참조 하세요. 

> [!NOTE] 
> Microsoft Endpoint Configuration Manager (현재 분기)를 사용 하는 경우 비즈니스 스토어를 구성 관리자로 연결 하 여 위의 단계를 건너뛸 수 있습니다. 이렇게 하면 구성 관리자를 사용 하 여 구입한 앱 목록을 동기화 하 고, Configuration Manager 콘솔에서 보고, 다른 앱과 같은 방식으로 배포할 수 있습니다. 자세한 내용은 [Configuration Manager를 사용 하 여 비즈니스용 Microsoft 스토어에서 앱 관리](https://technet.microsoft.com/library/mt740630.aspx)를 참조 하세요.


## 요약

앱을 개발 하 고 있는지, 적은 수의 장치에서 앱을 평가 하거나, 조직에 광범위 하 게 앱을 배포 하는 경우에 따라 Surface Hub에 앱을 설치 하는 몇 가지 방법이 있습니다. 이 표에는 지원되는 방법이 요약되어 있습니다.
