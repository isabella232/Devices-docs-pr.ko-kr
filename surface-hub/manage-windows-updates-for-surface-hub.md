---
title: Surface Hub에서 Windows 업데이트 관리
...
ms.locfileid: "10836966"
---
# Surface Hub에서 Windows 업데이트 관리
...
| --------- | --------- | --------- | --------- | --------- | --------- |
| 미리 보기(예: 중요하지 않은 또는 테스트용 장치) | 소형 | Windows 참가자 미리 보기 | 없음.  | 없음.  | 새 기능을 수동으로 테스트 및 평가합니다. 문제가 있는 경우 업데이트를 일시 중지합니다. |
...
업무 시간 중에 항상 장치를 사용할 수 있도록 Surface Hub는 지정된 유지 관리 기간 동안 관리 기능을 수행합니다. 유지 관리 기간 동안 Surface Hub는 Windows 업데이트 또는 WSUS를 통해 자동으로 업데이트를 설치하고 필요한 경우 장치를 다시 시작합니다.
